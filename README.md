# block_simple_getter
block_simple_getter is a collection of utilities for interacting with Web3 and Ethereum smart contracts.
...
```bash
npm install block_simple_getter
```
## Usage

const Web3Tools = require('block_simple_getter');
